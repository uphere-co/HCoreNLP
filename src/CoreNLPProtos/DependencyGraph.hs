...
module CoreNLPProtos.DependencyGraph (DependencyGraph(..), node, edge, root) where
import Prelude ((+), (/))
...
import qualified CoreNLPProtos.DependencyGraph.Edge as CoreNLPProtos.DependencyGraph (Edge)
import qualified CoreNLPProtos.DependencyGraph.Node as CoreNLPProtos.DependencyGraph (Node)
