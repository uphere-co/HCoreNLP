...
module CoreNLPProtos.DependencyGraph.Edge (Edge(..), source, target, dep, isExtra, sourceCopy, targetCopy, language) where
import Prelude ((+), (/))
...
import qualified CoreNLPProtos.Language as CoreNLPProtos (Language)
