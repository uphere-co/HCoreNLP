...
module CoreNLPProtos.NaturalLogicRelation (NaturalLogicRelation(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum NaturalLogicRelation where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type CoreNLPProtos.NaturalLogicRelation") .
      toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type CoreNLPProtos.NaturalLogicRelation"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type CoreNLPProtos.NaturalLogicRelation"
...
instance P'.ReflectEnum NaturalLogicRelation where
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".edu.stanford.nlp.pipeline.NaturalLogicRelation") [] ["CoreNLPProtos"] "NaturalLogicRelation")
      ["CoreNLPProtos", "NaturalLogicRelation.hs"]
