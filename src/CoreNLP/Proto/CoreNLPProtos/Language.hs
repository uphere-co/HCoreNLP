...
module CoreNLP.Proto.CoreNLPProtos.Language (Language(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Language where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type CoreNLP.Proto.CoreNLPProtos.Language") .
      toMaybe'Enum
  succ Unknown = Any
  succ Any = Arabic
  succ Arabic = Chinese
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type CoreNLP.Proto.CoreNLPProtos.Language"
  pred Any = Unknown
  pred Arabic = Any
  pred Chinese = Arabic
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type CoreNLP.Proto.CoreNLPProtos.Language"
...
instance P'.ReflectEnum Language where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".edu.stanford.nlp.pipeline.Language") ["CoreNLP", "Proto"] ["CoreNLPProtos"] "Language")
      ["CoreNLP", "Proto", "CoreNLPProtos", "Language.hs"]
