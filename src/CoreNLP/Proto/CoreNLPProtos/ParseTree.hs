...
module CoreNLP.Proto.CoreNLPProtos.ParseTree (ParseTree(..), child, value, yieldBeginIndex, yieldEndIndex, score, sentiment) where
import Prelude ((+), (/))
