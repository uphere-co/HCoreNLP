...
module CoreNLP.Proto.CoreNLPProtos.Relation
       (Relation(..), argName, arg, signature, objectID, extentStart, extentEnd, type', subtype) where
import Prelude ((+), (/))
